...
def extract_pdf_meta(data: bytes) -> dict[str, Any]:
    ...
    return {"pages": pages, "author": author, "title": title, "producer": producer, "created": created}
...
def extract_docx_meta(data: bytes) -> dict[str, Any]:
    ...
    return {"paragraphs": paragraphs, "tables": tables, "title": core.title, "author": core.author, "created": str(core.created)}
